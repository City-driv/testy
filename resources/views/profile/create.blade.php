...
@section('title','Créer profile')
@section('content')
    
{{-- form --}}
<form action="{{route('profile.store')}}" method="POST" >
@csrf
<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center mt-16 px-5 py-5">
        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-gray-900">Ajouter nouvel Utilisateur </h1>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" name="name" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Jon Snow">
                            </div>
                            @error('name')
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="email" name="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="jonSnow@example.com">
                            </div>
                            @error('email')
                                 <span class="text-xs font-semibold px-1 text-red-600">{{$message}}</span>
                            @enderror
